...
<header class="d-flex w-100">
	<nav class="navbar navbar-expand-lg w-100 bg-light">
		<div class="navbar navbar-inverse  w-100 justify-content-between">
			<ul class="navbar-nav" id="navbar">
				...
				<?php if (isset($_SESSION['loggedin']) && $_SESSION['loggedin'] == true) {
					...
					if ($_SESSION['role'] == 'admin') { ?>
						...
						<li class="nav-item">
							<a class="nav-link text-dark" href="<?php echo $server; ?>components/user/view.php">Users</a>
						</li>
					<?php } else { ?>
						<li class="nav-item">
							<a class="nav-link text-dark" href="<?php echo $server; ?>components/booking/view.php">Bookings</a>
						...
						<li class="nav-item">
							<a class="nav-link text-dark" href="<?php echo $server; ?>components/profile/customer-details.php">Profile</a>
						</li>
				<?php } 
				} ?>
			</ul>
			<ul class="navbar-nav">
				<div class="d-flex my-2 my-lg-0">
				    ...
				    <button id="searchBtn"class="btn btn-info m-2 my-sm-0" type="button">Search</button>
				</div>
			</ul>
			<ul class="navbar-nav">
				<?php 
