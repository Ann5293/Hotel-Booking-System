<div class="col-xs-12 col-sm-6 col-md-6 col-lg-3 my-2">
					...
					<div class="modal-content">
						<form method="post">
							...
							<div class="modal-header">
								<h3 class="modal-title" style="line-height: 1.0;" id="confirmTitle">Book Room 
									<span>
										<small><br>Room Type: <?php echo $r['type']; ?> </small>
									</span>
									<span>
										<small><br>Price: $<?php echo $r['price']; ?> </small>
									</span>
								</h3>
							...
							<div class="modal-body">
								...
								<sub>*The <span style="color:red;">check in</span> date cannot be greater than <span style="color:red;">check out</span> date.</sub>
